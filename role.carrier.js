var roleCarrier = {
    run: function (creep, structures) {
        ...
        function source() {  //selection of a higher priority source
            if (structures.links[0] && structures.links[0].store[RESOURCE_ENERGY] >= 100) return structures.links[0];
            else if (container && container.store[RESOURCE_ENERGY] >= 100) return container;
